    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Duyurular</a></li>
            </ol>
        </div>
                                                ...
                                                <div class="card-body p-3">
                                                    <div class="profile-uoloaded-post">
                                                        <div class="media mb-3 align-items-center">
                                                            <img src="{{ $announcement->user->profile_image ? asset('storage/' . $announcement->user->profile_image) : asset('images/profile/profile.png') }}" alt="" class="img-fluid rounded-circle me-3" style="width: 40px; height: 40px; object-fit: cover;">
                                                        ...
                                                        <div class="d-flex border-top pt-2 align-items-center">
                                                            <button class="btn btn-primary btn-xs me-2"><span class="me-2"><i class="fa fa-heart"></i></span>Beğen</button>
                                                            <button class="btn btn-secondary btn-xs" data-bs-toggle="collapse" data-bs-target="#comment-{{ $announcement->id }}"><span class="me-2"><i class="fa fa-reply"></i></span>Yanıtla</button>
                                                        </div>
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <div class="d-flex mb-2">
                                                                <img src="{{ $comment->user->profile_image ? asset('storage/' . $comment->user->profile_image) : asset('images/profile/profile.png') }}" alt="" class="img-fluid rounded-circle me-2" style="width: 30px; height: 30px; object-fit: cover;">
